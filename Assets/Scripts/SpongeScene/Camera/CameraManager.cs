...
namespace Camera
{
    public class CameraManager : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            CoreManager.Instance.CameraManager = this;
            Player = CoreManager.Instance.player.gameObject;
            ...
            CoreManager.Instance.EventsManager.AddListener(EventNames.StartEndCutScene, OnEndCutScene);
