...
namespace SpongeScene.Menus
{
    public class PauseMenu : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            buttons = new Button[] { resumeButton, restartButton, mainMenuButton}; //otherButton, 
        }
        ...
        void OnEnable()
        {
            ...
            if (CoreManager.Instance.SceneManager is not null && CoreManager.Instance.SceneManager.sceneType == SceneType.Cutscene)
            {
        ...
        void Submit(InputAction.CallbackContext obj)
        {
            ...
            if (buttons[selectedButtonIndex] == resumeButton)
            {
                OnResume();
            }

            else if (buttons[selectedButtonIndex] == mainMenuButton)
            {
                OnMainMenu();
            }
        ...
        void OnMainMenu()
        {
            ...
            CoreManager.Instance.player.gameObject.SetActive(false);
            print("EXIT 22");
