    ...
    public static class UtilityFunctions
    {
        ...
        public static int CountPressedButtons()
        {
            ...
            Key[] validKeys = new Key[]
            {
                ...
                Key.Digit0, Key.Digit1, Key.Digit2, Key.Digit3, Key.Digit4, Key.Digit6, Key.Digit5, Key.Digit7, Key.Digit8, Key.Digit9,  // Top row numbers
                Key.Numpad0, Key.Numpad1, Key.Numpad2, Key.Numpad3, Key.Numpad4, Key.Numpad5, Key.Numpad6, Key.Numpad7, Key.Numpad8, Key.Numpad9,  // Numeric keypad
                Key.Space, Key.Enter, Key.Escape, Key.Backspace, Key.Tab, Key.CapsLock, Key.UpArrow, Key.DownArrow, Key.LeftArrow, Key.RightArrow
        ...
        public static IEnumerator LerpColor(Renderer renderer, Color fromColor, Color toColor, float duration, Action? onComplete = null)
        {
            float elapsedTime = 0f;
        ...
        public static Vector3 UIToWorldNearCamera(RectTransform uiElement, Canvas canvas, UnityEngine.Camera camera, float distanceFromCamera = 5f)
        {
            ...
            Vector3 worldPoint = camera.ScreenToWorldPoint(new Vector3(screenPoint.x, screenPoint.y, distanceFromCamera));
